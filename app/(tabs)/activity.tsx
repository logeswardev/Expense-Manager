...
const CATEGORY_ICONS: Record<string, IoniconsName> = { Shopping: 'bag-handle-outline', Transport: 'car-outline', Dining: 'restaurant-outline', Bills: 'flash-outline', Income: 'wallet-outline' };
...
export default function ActivityScreen() {
  ...
  const filtered = useMemo(() => transactions.filter((item) =>
    item.merchant.toLowerCase().includes(search.toLowerCase()) && (filter === 'All' || item.category === filter)), [transactions, search, filter]);
